            ...
            VStack {
                if !todoListViewModel.todos.isEmpty {
                    CustomNavigationBar(isDisplayLeftBtn: false,
                                        rightBtnAction: { todoListViewModel.navigationRightButtonTapped() },
...
private struct TodoCellView: View {
    ...
    fileprivate init(isRemoveSeleted: Bool = false, todo: Todo) {
    ...
    var body: some View {
        ...
        VStack(spacing: 20) {
            ...
            HStack {
                ...
                if !todoListViewModel.isEditTodMode {
                ...
                if todoListViewModel.isEditTodMode {
                    Button(action: { isRemoveSeleted.toggle(); todoListViewModel.todoRemoveSelectedBoxTapped(todo) }) {
