...
struct VoiceRecorderView: View {
    ...
    var body: some View {
        ...
        .alert("선택된 음성메모를 삭제하시겠습니까?", isPresented: $voiceRecorderViewModel.isDisplayRemoveVoiceReocrderAlert) {
            Button("삭제", role: .destructive) {
                voiceRecorderViewModel.removeSelectedVocieRecord()
            }
            
            Button("삭제", role: .cancel) {}
        }
        .alert(voiceRecorderViewModel.errorAlertMessage, isPresented: $voiceRecorderViewModel.isDisplayAlert) {
        ...
        ScrollView(.vertical) {
            ...
            VStack {
                ...
                ForEach(voiceRecorderViewModel.recordedFiles, id: \.self) { recordedFile in
                    ...
                    // 음성메모 셀 뷰, 호출
                    VocieRecorderCellView(voiceRecorderViewModel: voiceRecorderViewModel, recordedFile: recordedFile)
                }
            }
        }
    }
...
// MARK: - 음성메모 셀 뷰
private struct VocieRecorderCellView: View {
    ...
    init(voiceRecorderViewModel: VoiceRecorderViewModel, recordedFile: URL) {
        self.voiceRecorderViewModel = voiceRecorderViewModel
    ...
    var body: some View {
        VStack {
            ...
            Button(action: { voiceRecorderViewModel.voiceRecordCellTapped(recordedFile) }) {
            ...
            if voiceRecorderViewModel.selectedRecoredFile == recordedFile {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        Button(action: { voiceRecorderViewModel.removeBtnTapped() }) {
...
private struct RecordBtnView: View {
    ...
    init(voiceRecordViewModel: VoiceRecorderViewModel) {
    ...
    fileprivate var body: some View {
        ...
        VStack {
            ...
            HStack {
                ...
                Button(action: { voiceRecordViewModel.recordBtnTapped() }) {
